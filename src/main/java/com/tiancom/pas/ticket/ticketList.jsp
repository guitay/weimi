	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function audit(sel,isApproved){
				...
				custom_window('../ticket/ticket.do?method=loadLC&procinstid='+procinstid,1000,500,'订票流程');
				/*if(isApproved){
					msg = "您确定'审批同意'该报销单吗？";
				}else{
					msg= "您确定‘审批不同意’该报销单吗？";
	...
	<BODY>
		<div id="fun_panel">
			...
			<div id="query_conn_panel">
				<html:form action="/ticket.do?method=queryByCondition" method="post">
					<table id="query_table">
						<tr>
							...
							<td>
								<html:text property="ddbh" style="width:120px" />
							</td>
...
<%--							</td>--%>
			...
			<div id="data_panel">
				<pastag:list key="ticket" url="ticket.do?method=queryByCondition" type="manage"></pastag:list>
			</div>
		</div>
	</BODY>
	<script type="text/javascript">
	 function loadData2()
	 {
		 ...
		 var params = jQuery("form[name=ticketForm]").serializeJSON();
		 jQuery('#ticketList').datagrid({pageNumber:1,url: 'ticket.do?method=queryByCondition',queryParams:params});
	 }
